...
namespace QRSCS.Manager
{
    public class IndividualizedEPlanManager
    {
        ...
        public bool UpdateIEPData(IEPlanModel iEPModel)
        {
            var data = db.IEPlans.FirstOrDefault(x => x.IEPlan_ID == iEPModel.IEPlan_ID);

            //data.Date_Of_Assessment = Convert.ToDateTime(iEPModel.Date_Of_Assessment);
        ...
        public dynamic GetIEPDatabyId(int GRNO)
        {
            try
            {
                ...
                for (var i = 0; i < data.Count; i++)
                {
                   ...
                   // iEPData.Year = data[i].Date_Of_Assessment.Value.Year.ToString();
        ...
        public IEPlanModel GetIEPData(int IEP_ID, int GRNO)

        {
            try
            {
                ...
                IEPlanModel ePlanModelDTO = new IEPlanModel()
                {
